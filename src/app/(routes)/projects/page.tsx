...
export default function page() {
  ...
  const sorted = projects.slice(3); // Extrae los proyectos desde el índice 3 hasta el final
  return (
            ...
            {[top2, top3].map((project) => (
              project && (
                <Card key={project.slug}>
                  <Article project={project} views={100} />
                </Card>
              )
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 gap-4 mx-auto lg:mx-0 md:grid-cols-3">
          <div className="grid grid-cols-1 gap-4">
            {sorted
              ...
              .map((project) => (
                <Card key={project.slug}>
                  <Article project={project} views={1200} />
                </Card>
              ))}
          </div>
          <div className="grid grid-cols-1 gap-4">
            {sorted
              ...
              .map((project) => (
                <Card key={project.slug}>
                  <Article project={project} views={1000} />
                </Card>
              ))}
          </div>
          <div className="grid grid-cols-1 gap-4">
            {sorted
              ...
              .map((project) => (
                <Card key={project.slug}>
                  <Article project={project} views={1300} />
                </Card>
              ))}
          </div>
        </div>
